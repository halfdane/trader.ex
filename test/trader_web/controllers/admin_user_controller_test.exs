defmodule TraderWeb.AdminUserControllerTest do
  ...
  setup do
    ...
    {:ok,
     conn: build_conn(), user: user, admin: admin, user_role: user_role, admin_role: admin_role}
  end
  ...
  describe "create user" do
    ...
    test "prohibit post when data is valid for normal users", %{
      conn: conn,
      user_role: user_role,
      user: user
    } do
    ...
    test "create user when data is valid for admin", %{
      conn: conn,
      user_role: user_role,
      admin: admin
    } do
    ...
    test "renders errors when data is invalid for admin user", %{
      conn: conn,
      user_role: user_role,
      admin: admin
    } do
  ...
  describe "edit user" do
    test "prohibits access to form for editing chosen user if not logged in", %{
      conn: conn,
      user: user
    } do
    ...
    test "prohibits access to form for editing chosen user for normal user", %{
      conn: conn,
      user: user
    } do
      conn =
  ...
  describe "update user" do
    ...
    test "redirects when data is valid when logged in as admin", %{
      conn: conn,
      user: user,
      admin: admin
    } do
